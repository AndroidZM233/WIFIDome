package com.speedata.wifidome.utils;
...
public class WifiDeviceControl {
    //kt系列
    public static final String POWER_MAIN = "/sys/class/misc/mtgpio/pin";
    //tt系列
    public static final String POWER_EXTERNAL = "/sys/class/misc/aw9524/gpio";
    ...
    public WifiDeviceControl(String path) throws IOException {
     ...
     * @throws IOException
     */
    public WifiDeviceControl(PowerType power_type, int... gpios) throws IOException {
        this.gpios = gpios;
     ...
     * @throws IOException
     */
    public WifiDeviceControl(String power_type, int... gpios) throws IOException {
        this.gpios = gpios;
        switch (power_type) {
            case "MAIN":
    ...
    public void MainPowerOn(int gpio) throws IOException {
        WifiDeviceControl wifiDeviceControl = new WifiDeviceControl(POWER_MAIN);
        wifiDeviceControl.setGpio(gpio);
        wifiDeviceControl.writeON();
        wifiDeviceControl.DeviceClose();
    }
    ...
    public void ExpandPowerOn(int gpio) throws IOException {
        WifiDeviceControl wifiDeviceControl = new WifiDeviceControl(POWER_EXTERNAL);
        wifiDeviceControl.setGpio(gpio);
        wifiDeviceControl.writeON();
        wifiDeviceControl.DeviceClose();
    }
